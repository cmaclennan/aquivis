...
import { resolveCompanyIdForUser, updateMaintenanceTaskForService } from '@/lib/data/services'
...
export async function PATCH(
  ...
  try {
    ...
    try {
      const data = await updateMaintenanceTaskForService(id, taskId, updates, companyId)
      const res = NextResponse.json({ task: data })
