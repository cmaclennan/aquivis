...
CREATE INDEX IF NOT EXISTS idx_services_unit_id 
ON services(unit_id);

CREATE INDEX IF NOT EXISTS idx_services_technician_id 
...
-- Water tests indexes
CREATE INDEX IF NOT EXISTS idx_water_tests_service_id 
ON water_tests(service_id);

CREATE INDEX IF NOT EXISTS idx_water_tests_all_parameters_ok 
